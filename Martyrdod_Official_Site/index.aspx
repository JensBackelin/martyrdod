...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="homeContent">
        <div id="homeVideo"><%--Youtube api embedded--%>
            <iframe src="//www.youtube.com/embed/WCXeQdFYoTM" frameborder="0" allowfullscreen></iframe>
        </div>
        <div id="homeLiveContent"> <%--Avsnitt med de närmast kommande spelningarna--%>
                <table>
                    <th colspan="2">
    ...
    <div id="fbLike"><%--Facebook api embedded, scriptkod finns på MasterPage--%>
